        ...
        <Reveal className="lg:col-span-2">
          ...
          <div className="mt-8 space-y-3 text-sm">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-orange-400 px-5 py-2.5 text-sm font-medium text-white shadow-soft transition-all hover:shadow-glow hover:scale-[1.02]"
            >
